...
//    Print Instructions to Player
    public void printInstructions(){
        System.out.println("Welcome to the MadLib game. If you type in "
...
//    Get data from Player
    ...
    public void putTogetherTheStory(){
        ...
        if (num == 0) {
            story = "Jessi and her best friend "+getName()+" went to Disney World today!"
                    +" They saw a "+getNoun1()+" in a show at the Magic Kingdom"
                    +" and ate a "+getAdjective1()+" feast for dinner. The next day we"
                    +" ran "+getAdverb()+" to meet Mickey Mouse in his "+getNoun2()
                    +" and then that night we gazed at the "+getRandomNums()+" "
